...
ECR_REPO="879654127886.dkr.ecr.us-east-1.amazonaws.com/kootoro-dev-ecr-react-frontend-f6d3xl"

# ECS - Update these to your ECS cluster and service names
ECS_CLUSTER="react-frontend-dev-react-f6d3xl-cluster"
ECS_SERVICE="react-frontend-dev-react-f6d3xl"
