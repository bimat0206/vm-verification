...
func (v *Validator) ValidateReferenceStructure(references map[string]*s3state.Reference) error {
	if references == nil {
...
func (v *Validator) ValidateReferenceAccumulation(input, output map[string]*s3state.Reference) error {
