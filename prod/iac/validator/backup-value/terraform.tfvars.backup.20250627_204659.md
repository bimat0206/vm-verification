...
react_frontend = {
  create_react                     = true # Set to true when you want to deploy React frontend
  service_name                     = "react-frontend"
  image_uri                        = "879654127886.dkr.ecr.us-east-1.amazonaws.com/kootoro-dev-ecr-react-frontend-f6d3xl:latest" # Updated to use correct React image
