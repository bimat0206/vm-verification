# IAM roles and policies for ECS React
...
resource "aws_iam_policy" "ecs_cloudwatch_policy" {
  ...
  description = "Policy for React ECS tasks to write logs and metrics"
...
resource "aws_iam_policy" "ecs_ecr_policy" {
  ...
  description = "Policy for React ECS tasks to access ECR"
...
resource "aws_iam_policy" "ecs_api_gateway_policy" {
  ...
  description = "Policy for React ECS tasks to access API Gateway"
...
resource "aws_iam_policy" "ecs_s3_policy" {
  ...
  description = "Policy for React ECS tasks to access S3 buckets"
...
resource "aws_iam_policy" "ecs_dynamodb_policy" {
  ...
  description = "Policy for React ECS tasks to access DynamoDB tables"
...
resource "aws_iam_policy" "ecs_secretsmanager_policy" {
  ...
  description = "Policy for React ECS tasks to access Secrets Manager"
